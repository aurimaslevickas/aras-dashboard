...
import { ArrowLeft, MapPin, Clock, Phone, Globe, Wine, Heart, Share2, Navigation } from 'lucide-react';
...
const BarDetailPage = () => {
  ...
  const backUrl = getCategoryUrl(locale, 'bar');
  ...
  if (!item) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-2">{t('detail.bar.notFound')}</h2>
          <Link to={backUrl} className="text-slate-600 hover:text-slate-800">
            {t('nav.bar')}
          </Link>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b">
        <div className="container mx-auto px-4 py-4">
          <Link to={backUrl} className="inline-flex items-center space-x-2 text-slate-600 hover:text-slate-800 font-medium">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
            ...
            <div className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">{t('detail.bar.about')}</h2>
              <div
            ...
            <div className="sticky top-8 space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  {item.contact_info?.website && (
                    <div className="flex items-center space-x-3">
                      ...
                      <a href={item.contact_info.website} target="_blank" rel="noopener noreferrer" className="font-medium text-slate-600 hover:underline truncate">
                        {item.contact_info.website}
                      </a>
                    </div>
                  )}
              ...
              <div className="space-y-3">
                <a
                  ...
                  className="w-full bg-slate-600 hover:bg-slate-700 text-white py-3 px-4 rounded-lg font-semibold transition-colors flex items-center justify-center space-x-2"
                >
