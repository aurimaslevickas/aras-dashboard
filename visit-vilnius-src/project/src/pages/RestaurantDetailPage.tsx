...
import { ArrowLeft, MapPin, Clock, Star, Phone, Globe, Utensils, Heart, Share2, Navigation } from 'lucide-react';
...
const RestaurantDetailPage = () => {
  ...
  const backUrl = getCategoryUrl(locale, 'eat');
  ...
  if (!item) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-2">{t('detail.restaurant.notFound')}</h2>
      ...
      <div className="bg-white border-b">
        <div className="container mx-auto px-4 py-4">
          <Link to={backUrl} className="inline-flex items-center space-x-2 text-orange-600 hover:text-orange-800 font-medium">
            ...
            <span>{t('category.restaurant')}</span>
          </Link>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
            ...
            <div className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">{t('detail.restaurant.about')}</h2>
              <div
