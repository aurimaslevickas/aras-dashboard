...
import { ArrowLeft, MapPin, Clock, Star, Phone, Globe, Bed, Heart, Share2, Navigation } from 'lucide-react';
...
const HotelDetailPage = () => {
  ...
  const backUrl = getCategoryUrl(locale, 'stay');
  ...
  if (!item) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-2">{t('detail.hotel.notFound')}</h2>
          <Link to={backUrl} className="text-orange-600 hover:text-orange-800">
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b">
        <div className="container mx-auto px-4 py-4">
          <Link to={backUrl} className="inline-flex items-center space-x-2 text-orange-600 hover:text-orange-800 font-medium">
            <ArrowLeft className="w-4 h-4" />
            <span>{t('category.accommodation')}</span>
          </Link>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
            ...
            <div className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">{t('detail.hotel.about')}</h2>
              <div
            ...
            {features.length > 0 && (
              <div className="mb-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-4">{t('detail.hotel.features')}</h2>
                ...
                <div className="space-y-4">
                  ...
                  {item.contact_info?.website && (
                    <div className="flex items-center space-x-3">
                      ...
                      <a href={item.contact_info.website} target="_blank" rel="noopener noreferrer" className="font-medium text-orange-600 hover:underline truncate">
                        {item.contact_info.website}
                      </a>
                    </div>
                  )}
